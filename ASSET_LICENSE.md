# Peach Butt artwork and brand assets

The MIT License in this repository applies to source code and documentation. It does not grant rights to the Peach Butt / 桃屁屁 name, character identity, logo, illustrations, source videos, generated motion clips, or other original visual assets under `assets/` and `docs/images/`.
