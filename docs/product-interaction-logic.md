...
- 恰好在第 7 / 30 / 100（及之后每满 100）天的当天首次启动时，改播 `dance.webm` 庆祝舞蹈 + 彩带，气泡「我们互相陪伴 N 天啦！以后也要一起哦」，替代当天的每日问候。
...
- 跨过门槛升级时，播一次 `transform.webm` 变身动画，气泡「我长大啦！现在是XX了！」。
- 每升一级解锁一句新的待机口头禅加入气泡池（如小桃「长出小桃子啦，一起加油」、仙桃「仙桃状态全开，放心交给我」），按分钟轮换。
- 当前等级随快照下发（`AppSnapshot.growth`），供界面展示与气泡池使用。首次启动以当前累计能量为基线，不会误播升级动画。
